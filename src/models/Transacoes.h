...
class Transacoes
{
  public:
     ...
     */
    explicit Transacoes(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Transacoes(const Json::Value &pJson) noexcept(false);
     ...
     */
    Transacoes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Transacoes, false, true>;
    friend drogon::orm::BaseBuilder<Transacoes, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Transacoes>;
#endif
