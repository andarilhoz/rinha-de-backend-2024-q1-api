...
const std::string Transacoes::Cols::_cliente_id = "cliente_id";
...
{"tipo","std::string","character",0,0,0,1},
{"descricao","std::string","character varying",10,0,0,1},
{"realizada_em","::trantor::Date","timestamp without time zone",0,0,0,1}
};
...
void Transacoes::updateByMasqueradedJson(const Json::Value &pJson,
...
const std::shared_ptr<int32_t> &Transacoes::getId() const noexcept
{
    return id_;
}
...
const int32_t &Transacoes::getValueOfClienteId() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(clienteId_)
        return *clienteId_;
...
const std::shared_ptr<int32_t> &Transacoes::getClienteId() const noexcept
{
    return clienteId_;
}
void Transacoes::setClienteId(const int32_t &pClienteId) noexcept
{
...
const std::shared_ptr<int32_t> &Transacoes::getValor() const noexcept
{
    return valor_;
}
...
const std::shared_ptr<std::string> &Transacoes::getTipo() const noexcept
{
    return tipo_;
}
...
const std::shared_ptr<std::string> &Transacoes::getDescricao() const noexcept
{
    return descricao_;
}
...
Json::Value Transacoes::toMasqueradedJson(
...
bool Transacoes::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("tipo"))
    {
        if(!validJsonOfField(3, "tipo", pJson["tipo"], err, true))
            return false;
    }
    else
    {
...
bool Transacoes::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Transacoes::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("tipo"))
    {
        if(!validJsonOfField(3, "tipo", pJson["tipo"], err, false))
            return false;
    }
    if(pJson.isMember("descricao"))
    {
...
bool Transacoes::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                  const std::vector<std::string> &pMasqueradingVector,
                                                  std::string &err)
{
    if(pMasqueradingVector.size() != 6)
...
bool Transacoes::validJsonOfField(size_t index,
